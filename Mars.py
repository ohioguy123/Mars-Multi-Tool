...
███╗   ███╗ █████╗ ██████╗ ███████╗
████╗ ████║██╔══██╗██╔══██╗██╔════╝                     ------------------------------------
██╔████╔██║███████║██████╔╝███████╗ (V2)                | credit = abbasthecoder (discord) |
██║╚██╔╝██║██╔══██║██╔══██╗╚════██║                     |  https://github.com/ohioguy123   |
██║ ╚═╝ ██║██║  ██║██║  ██║███████║                     | -------------------------------  | 
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝
...
while True:
    ...
    if q == "1":
        ...
        from data import ddosme
    else:
        print("Invalid character, option not available.")
